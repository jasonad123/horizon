...
Forged with the core of [Headsign](https://github.com/jasonad123/headsign), but built even simpler and made to be *horizontal*.

![Screenshot](/assets/horizon-screenshot.png)

<div style="text-align:center">

<img src="https://github.com/jasonad123/horizon/blob/main/assets/transit-api-badge.png?raw=true" width="25%" />
...
> [!WARNING]
> Horizon comes with no guarantee of any kind. I am **not** affiliated with Transit, just a big fan of their app.
